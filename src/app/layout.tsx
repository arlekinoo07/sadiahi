          ...
          <div className="relative z-10 flex min-h-screen flex-col">
              ...
              <div className="mx-auto flex w-full max-w-7xl flex-col gap-4 px-4 py-4 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
                <div className="flex items-center justify-between gap-4">
                  <Link href="/" className="cursor-pointer">
                    <p className="text-xs font-bold uppercase tracking-[0.28em] text-[#ffd6a5]">
                      Sidiahi Training
                    </p>
            ...
            <footer className="border-t border-white/8">
              <div className="mx-auto flex w-full max-w-7xl flex-col gap-3 px-4 py-6 text-sm text-white/52 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
                <p>Тренировочный сайт на Next.js без тяжелой базы данных.</p>
                <p>Редактирование тренировок работает локально в браузере.</p>
              </div>
            </footer>
          </div>
        </div>
